...
if("TRUE" STREQUAL "TRUE")
  set(imu_sensor_controller_SOURCE_PREFIX /home/iftimie/tiago_public_ws/src/ros_controllers/imu_sensor_controller)
  set(imu_sensor_controller_DEVEL_PREFIX /home/iftimie/tiago_public_ws/devel/.private/imu_sensor_controller)
  ...
  set(imu_sensor_controller_INSTALL_PREFIX /home/iftimie/tiago_public_ws/install)
...
if(NOT "/home/iftimie/tiago_public_ws/src/ros_controllers/imu_sensor_controller/include " STREQUAL " ")
  set(imu_sensor_controller_INCLUDE_DIRS "")
  set(_include_dirs "/home/iftimie/tiago_public_ws/src/ros_controllers/imu_sensor_controller/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'imu_sensor_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/iftimie/tiago_public_ws/src/ros_controllers/imu_sensor_controller/${idir}'.  Ask the maintainer 'Adolfo Rodriguez Tsouroukdissian <adolfo.rodriguez@pal-robotics.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/iftimie/tiago_public_ws/devel/.private/imu_sensor_controller/lib;/home/iftimie/tiago_public_ws/devel/lib;/opt/ros/indigo/lib)
