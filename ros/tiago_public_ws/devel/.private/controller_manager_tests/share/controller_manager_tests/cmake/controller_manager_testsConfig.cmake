...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_tests_SOURCE_PREFIX /home/iftimie/tiago_public_ws/src/ros_control/controller_manager_tests)
  set(controller_manager_tests_DEVEL_PREFIX /home/iftimie/tiago_public_ws/devel/.private/controller_manager_tests)
  ...
  set(controller_manager_tests_INSTALL_PREFIX /home/iftimie/tiago_public_ws/install)
...
if(NOT "/home/iftimie/tiago_public_ws/src/ros_control/controller_manager_tests/include " STREQUAL " ")
  set(controller_manager_tests_INCLUDE_DIRS "")
  set(_include_dirs "/home/iftimie/tiago_public_ws/src/ros_control/controller_manager_tests/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager_tests' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/iftimie/tiago_public_ws/src/ros_control/controller_manager_tests/${idir}'.  Ask the maintainer 'Vijay Pradeep <vijay@hidof.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/iftimie/tiago_public_ws/devel/.private/controller_manager_tests/lib;/home/iftimie/tiago_public_ws/devel/lib;/opt/ros/indigo/lib)
