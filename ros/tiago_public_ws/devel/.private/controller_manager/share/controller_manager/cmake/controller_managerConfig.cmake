...
if("TRUE" STREQUAL "TRUE")
  set(controller_manager_SOURCE_PREFIX /home/iftimie/tiago_public_ws/src/ros_control/controller_manager)
  set(controller_manager_DEVEL_PREFIX /home/iftimie/tiago_public_ws/devel/.private/controller_manager)
  ...
  set(controller_manager_INSTALL_PREFIX /home/iftimie/tiago_public_ws/install)
...
if(NOT "/home/iftimie/tiago_public_ws/src/ros_control/controller_manager/include;/usr/include " STREQUAL " ")
  set(controller_manager_INCLUDE_DIRS "")
  set(_include_dirs "/home/iftimie/tiago_public_ws/src/ros_control/controller_manager/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/iftimie/tiago_public_ws/src/ros_control/controller_manager/${idir}'.  Ask the maintainer 'Wim Meeussen <wim@hidof.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/iftimie/tiago_public_ws/devel/.private/controller_manager/lib;/home/iftimie/tiago_public_ws/devel/lib;/opt/ros/indigo/lib)
