...
if("TRUE" STREQUAL "TRUE")
  set(map_msgs_SOURCE_PREFIX /home/iftimie/catkin_ws/src/map_msgs)
  set(map_msgs_DEVEL_PREFIX /home/iftimie/catkin_ws/devel)
  set(map_msgs_INSTALL_PREFIX "")
  set(map_msgs_PREFIX ${map_msgs_DEVEL_PREFIX})
else()
  set(map_msgs_SOURCE_PREFIX "")
  set(map_msgs_DEVEL_PREFIX "")
  set(map_msgs_INSTALL_PREFIX /home/iftimie/catkin_ws/install)
...
if(NOT "/home/iftimie/catkin_ws/devel/include " STREQUAL " ")
  set(map_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/iftimie/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'map_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Stéphane Magnenat <stephane@magnenat.net>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'map_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/iftimie/catkin_ws/src/map_msgs/${idir}'.  Ask the maintainer 'Stéphane Magnenat <stephane@magnenat.net>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/iftimie/catkin_ws/devel/lib;/opt/ros/indigo/lib)
